(function() {
  ...
  */
  ...
  function cpfFormatado(cpf) {
    var regexCPF = /(\d{3})(\d{3})(\d{3})/g;
    return cpf.replace(regexCPF, '$1.$2.$3-');
  }

  console.log(cpfFormatado('04921434211'));
  console.log(cpfFormatado('21045852205'));
  console.log(cpfFormatado('73550079422'));
  console.log(cpfFormatado('10112313132'));
