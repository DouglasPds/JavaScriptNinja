(function() {
  ...
  */
  var nordeste = ['Alagoas', 'Bahia', 'Ceará', 'Maranhão', 'Paríba', 'Pernambuco', 'Piauí', 'Rio Grande do Norte', 'Sergipe']
  ...
  */
  ...
  var cada = brasil.every(function(item){
    return item.length > 7;
  });

  if(cada) {
    console.log("Sim, todos os estados tem mais de 7 letras!");
  } else console.log("Nem todos os estados tem mais de 7 letras!");
  ...
  */
  ...
  //   item.id++, item.estado += ' pertence ao Brasil';
  //   return item;
  // });
