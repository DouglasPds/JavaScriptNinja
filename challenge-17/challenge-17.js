(function() {
  ...
  */
  ...
  text = text.replace(/Manuel Marques de Sousa/, 'Douglas Paulo dos Santos');
  console.log(text);
  ...
  */
  ...
  text = text.replace(/brasileiro/, 'anapolino');
  console.log(text);
  ...
  */
  ...
  console.log(text.replace(/(O Centauro de Luvas)/, function(grupo) {
  ...
  */
  ...
  //   var indice;
  //   months.filter(function(item, index) {
  //     if(nameMonth == item) {
  //       indice = index + 1;
  //     }
  //   });  
  //   return indice < 10 ? "0" + indice : String(indice);  
  // };
  ...
  */
  ...
  // var regexDate = text.replace(/(\d\d) de (junho|julho) de ([{\d}4])/g, '$1/$2/$3');
  var regexDate = /(\d\d) de (junho|julho) de ([{\d}4])/g;
  ...
  */
  ...
  //   return text.replace(regexDate, function(grupoTotal, grupo1, grupo2, grupo3) {
  //     return (grupo1 + '/' + getMonthNumber(grupo2) + '/' + grupo3);
  //   });
  // };
